...
output_dir = 'd:\uoal\videoshigh'; % pasta de saída dos vídeos
fps        = 60;                     % frames por segundo
resolution = '3840x2160';           % resolução 4K
crf        = 25;                     % qualidade (menor = melhor)

% Tabela: usuário → ObjectIDs (sem repetições entre usuários)
users = {
    1, [66, 35, 11, 10,  1, 12,  2, 14,  3, 16, 29];
    2, [ 0,135, 41, 43, 45, 47,  5, 68,  8, 19, 64];
    3, [22, 235, 51, 18, 53, 55, 57, 72, 58, 59    ];
    4, [61, 62, 37, 30, 82, 54, 88, 90              ];
    5, [12, 435, 71, 73, 75, 77, 15, 23             ];
};
